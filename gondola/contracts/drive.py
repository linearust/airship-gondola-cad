"""Finite, sourced gear choices using fixed replaceable servo/driver holders.
...
class DriveSpec:
    ...
    @property
    def servo_holder_sku(self):
        return f"ServoGearHolder{self.driver.teeth}T"
    ...
    def contract(self):
        return {
            **asdict(self),
            ...
            "servo_holder_print_sku": self.servo_holder_sku,
        }
